...
[[nodiscard]] RIVACORE_API double Median(std::vector<double> values);

class RIVACORE_API RollingMedianSpikeDetector {
 public:
  explicit RollingMedianSpikeDetector(const SpikeDetectionConfig& config = {});
